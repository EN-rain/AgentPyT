...
def _app_callback(ctx: typer.Context) -> None:
    ...
    if ctx.invoked_subcommand is None:
        ...
        raise typer.Exit()
    # Keep JSON and non-interactive outputs clean for scripts and tests.
...
def state_export(
    path: Annotated[str, typer.Option(help="Output file path")] = "pyagentt-state-export.json",
) -> None:
...
def state_import(
    path: Annotated[str, typer.Option(help="Input file path")] = "pyagentt-state-export.json",
